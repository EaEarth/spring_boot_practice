...
import com.example.practice.authservice.payload.request.LoginRequest;
import com.example.practice.authservice.payload.request.SignupRequest;
import com.example.practice.authservice.payload.response.JwtResponse;
import com.example.practice.authservice.payload.response.MessageResponse;
import com.example.practice.authservice.repository.AuthRepository;
import com.example.practice.authservice.security.jwt.JwtUtils;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        Auth user = new Auth(signUpRequest.getUsername(),
